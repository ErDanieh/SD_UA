...
public class VisitorEditAPI extends JFrame
{
	...
	public VisitorEditAPI(String url) {
		...
		ActionListener registro = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				visitante.pasarServidorEdicion(txtId.getText(), txtIdNew.getText(), txtNombre.getText(), txtPassword.getText(), txtPasswordNew.getText(), url);
