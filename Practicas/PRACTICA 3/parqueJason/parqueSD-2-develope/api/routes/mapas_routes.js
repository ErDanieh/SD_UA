...
// Listado de todos los mapa
routes.get("/mapas",(request, response) => {
    console.log('Listado de todos los mapa');
...
routes.get("/mapas/:id",(request, response) => {
    console.log('Informacion de un mapa');

    const {id} = request.params;
    const sql = `SELECT * FROM Mapa WHERE ID=${id}`;
